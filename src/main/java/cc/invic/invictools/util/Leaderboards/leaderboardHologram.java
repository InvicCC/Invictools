...
import cc.invic.invictools.gamemodifiers.WardenSpawner;
...
public class leaderboardHologram
{
    ...
    public void createLeaderboard()
    {
        ...
        leaderboard.add(ChatColor.WHITE + " " + ChatColor.BOLD + modifySort(cc.invic.invictools.util.Leaderboards.leaderboard.Sort) + ChatColor.AQUA + " " + ChatColor.BOLD + "Bedwars Leaderboard ");
        leaderboard.addAll(cc.invic.invictools.util.Leaderboards.leaderboard.formattedLeaderboard);
