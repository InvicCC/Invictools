package cc.invic.invictools.gamemodifiers.Manhunt;
...
import cc.invic.invictools.util.fixes.SafeOpCommand;
import org.bukkit.*;
...
public class ManhuntMain
{
    ...
    private List<String> cleanSyntax(List<String> effects)
    {
    ...
    String TranslateCustomItem(String text)
    {
    ...
    String translatePotion(String text)
    {
