...
import cc.invic.invictools.cosmetics.Lobby1Handler;
import cc.invic.invictools.cosmetics.NormalKillHandler;
import cc.invic.invictools.cosmetics.VictoryDances.VictoryDanceConfig;
...
import cc.invic.invictools.cosmetics.bedbreaks.BedBreakConfig;
import cc.invic.invictools.cosmetics.bedbreaks.BedBreaks;
import cc.invic.invictools.cosmetics.finalkills.FinalKillConfig;
import cc.invic.invictools.cosmetics.finalkills.FinalKillHandler;
import cc.invic.invictools.cosmetics.projtrail.ProjTrailConfig;
import cc.invic.invictools.cosmetics.projtrail.ProjTrailHandler;
import cc.invic.invictools.cosmetics.projtrail.ProjTrailPreview;
import cc.invic.invictools.gamemodes.bedfight;
import cc.invic.invictools.gamemodifiers.*;
import cc.invic.invictools.gamemodifiers.LuckyBlocks.createLuckyBlocks;
import cc.invic.invictools.gamemodifiers.Manhunt.ManhuntMain;
import cc.invic.invictools.gamemodifiers.PotionEffects.*;
import cc.invic.invictools.items.FireStick;
import cc.invic.invictools.items.createItems;
import cc.invic.invictools.items.dareListener;
import cc.invic.invictools.items.giveitem;
import cc.invic.invictools.util.*;
import cc.invic.invictools.util.Leaderboards.leaderboard;
import cc.invic.invictools.util.WorldBorder;
import cc.invic.invictools.util.Leaderboards.leaderboardHologram;
import cc.invic.invictools.util.fixes.ChangeTeamSize;
import cc.invic.invictools.util.fixes.LobbyInventoryFix;
import cc.invic.invictools.util.fixes.TeamSelection;
...
import static cc.invic.invictools.util.deathListener.addedNormalBlocks;
import static cc.invic.invictools.util.deathListener.coalBlocks;
...
public class Commands implements CommandExecutor, TabExecutor
{
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
    {
        ...
        else if (args.length >= 2 && args[0].equalsIgnoreCase("BedBreakTest") && args[2].equalsIgnoreCase("cp"))
        {
            Player player = (Player) sender;
            Location oldloc = player.getLocation();
